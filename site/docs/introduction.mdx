...
:::info RatOS 2.1.0-RC4
You are viewing the documentation for RatOS 2.1.0-RC4. If you have not upgraded to RC4, you should select 2.1.0-RC3 from the version dropdown above.
:::
...
- Rat Rig V-Core 4.1
- Rat Rig V-Core 4.1 Hybrid
- Rat Rig V-Core 4.1 IDEX
- Rat Rig V-Minion
- Rat Rig V-Chonk
...
<p>
	<Link to="https://discord.gg/RatRig" className="button button--primary">
