...
- LOAD_FILAMENT `[TEMP|TOOLHEAD|AUTOMATED]`
- \_DEFAULT_LOAD_FILAMENT `[TEMP|AUTOMATED]`
- \_IDEX_LOAD_FILAMENT `[TEMP|TOOLHEAD|AUTOMATED]`
- \_LOAD_FILAMENT `[TOOLHEAD|AUTOMATED]`
...
- \_MOVE_TO_PARKING_POSITION `[TOOLHEAD|AUTOMATED]`
- \_MOVE_TO_LOADING_POSITION `[TOOLHEAD|AUTOMATED]`
- \_CLEANING_MOVE `[TOOLHEAD|AUTOMATED]`

## macros/unload_filament.cfg

- UNLOAD_FILAMENT `[TEMP|TOOLHEAD|AUTOMATED]`
- \_DEFAULT_UNLOAD_FILAMENT `[TEMP|AUTOMATED]`
- \_IDEX_UNLOAD_FILAMENT `[TEMP|TOOLHEAD|AUTOMATED]`
- \_UNLOAD_FILAMENT `[TOOLHEAD|AUTOMATED]`
- \_LEGACY_UNLOAD_FILAMENT `[TOOLHEAD|AUTOMATED]`
...
- CALIBRATE_ADAPTIVE_MESH `[IDEX_MODE|BOTH_TOOLHEADS|PROFILE|X0|X1|Y0|Y1|T|ZERO_REF_POS_X|ZERO_REF_POS_Y]`
...
- BED_MESH_CALIBRATE `[... standard BED_MESH_CALIBRATE parameters]`
...
- BEACON_RATOS_CALIBRATION `[BED_TEMP|CHAMBER_TEMP]`
- BEACON_RATOS_CALIBRATE `[BED_TEMP|CHAMBER_TEMP]`
- BEACON_INITIAL_CALIBRATION `[_AUTOMATED]`
- BEACON_FINAL_CALIBRATION `[_AUTOMATED|_AUTOMATED_ALREADY_HEATED|BED_TEMP|CHAMBER_TEMP]`
- BEACON_POKE_TEST
- BEACON_MEASURE_BEACON_OFFSET
- \_BEACON_STORE_BEACON_OFFSET `[OFFSET]`
- \_BEACON_ECHO_BEACON_OFFSET
- \_BEACON_APPLY_SCAN_COMPENSATION_IF_ENABLED
- \_START_PRINT_PREFLIGHT_CHECK_BEACON_MODEL
- \_START_PRINT_PREFLIGHT_CHECK_BEACON_SCAN_COMPENSATION
- \_BEACON_SUBTRACT_CONTACT_EXPANSION_OFFSET
- \_BEACON_SET_RUNTIME_OFFSET `[OFFSET|MOVE]`
- Z_OFFSET_APPLY_PROBE
- \_BEACON_RESTORE_RUNTIME_OFFSET
- \_BEACON_RESTORE_RUNTIME_OFFSET_LOG_BEFORE_AFTER
- \_BEACON_OFFSET_COMPARE `[A|B]`
- BEACON_CREATE_SCAN_COMPENSATION_MESH `[_AUTOMATED|BED_TEMP|CHAMBER_TEMP]`
- BEACON_APPLY_SCAN_COMPENSATION `[PROFILE]`
- BEACON_WAIT_FOR_PRINTER_HEAT_SOAK `[LAYER_QUALITY|MAXIMUM_FIRST_LAYER_DURATION|MINIMUM_WAIT|MAXIMUM_WAIT|_FORCE_THRESHOLD]`
- SET_ZERO_REFERENCE_POSITION `[X|Y]`
- POKELOOP
