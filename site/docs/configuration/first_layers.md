...
RatOS 2.1.0-RC4 introduces significant improvements to the Beacon True Zero calibration and compensation system, greatly improving first layer accuracy and consistency. When combined with a thermally-stable gantry construction, such as the steel tube gantry of the Rat Rig V-Core 4.1, this allows for extremely accurate and consistent first layers. Long-held instincts about diagnosing and tuning first layers may need to be re-evaluated in light of these improvements.
